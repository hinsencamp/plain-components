...
export default class Modal extends React.Component {
  ...
  render() {
    ...
    return createPortal(
      isVisible && (
        <div className={styles.root + " " + className} ref={this.modalRef} role="dialog">
...
Modal.Header = function ModalHeader({className, children}) {
  return <header className={className ? className : styles.default}>{children}</header>;
};
...
Modal.Body = function ModalBody({className, children}) {
  return <div className={className ? className : styles.default}>{children}</div>;
};
...
Modal.Footer = function ModalFooter({className, children}) {
  return <footer className={className ? className : styles.default}>{children}</footer>;
};
...
class ModalButton extends React.Component {
  ...
  render() {
    ...
    return (
      <button ref={this.buttonRef} className={className ? className : (styles.default + " " + styles.button)} {...props}>
        {this.props.children}
      </button>
    );
  }
